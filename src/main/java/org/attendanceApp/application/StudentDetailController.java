...
public class StudentDetailController {
  ...
  public Node getView() {
    ...
    targetCol.setCellValueFactory(cellData -> new SimpleStringProperty(
        cellData.getValue().getTarget() != null ? cellData.getValue().getTarget().getName()
    ...
    statusCol.setCellValueFactory(cellData -> new SimpleStringProperty(
        cellData.getValue().isAbsentClaim() ? LanguageManager.getInstance().get("absent") : "Present"));
