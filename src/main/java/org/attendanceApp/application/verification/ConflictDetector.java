package org.attendanceApp.application.verification;
...
public class ConflictDetector {
  ...
  private boolean isInDirection(Position from, Position to,
      org.attendanceApp.application.entities.Direction direction) {
