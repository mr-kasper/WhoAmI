package org.attendanceApp.application.services;
...
public class FirestoreService {
    ...
    public static synchronized void initialize() {
        if (initialized)
            return; // Check initialized flag instead of firestore
        ...
        try {
            ...
            if (serviceAccount == null) {
                throw new IOException(
                        "Resource not found: serviceAccountKey.json. Make sure the file is in src/main/resources/");
            }
     ...
     */
    public static boolean pushClassroomToFirestore(String classroomId,
            Collection<org.attendanceApp.application.entities.Student> students)
        ...
        try {
            ...
            for (org.attendanceApp.application.entities.Student student : students) {
     ...
     */
    public static List<org.attendanceApp.application.entities.Student> getClassroomFromFirestore(String classroomId)
            throws ExecutionException, InterruptedException {

        List<org.attendanceApp.application.entities.Student> students = new ArrayList<>();
        ...
        try {
            ...
            for (QueryDocumentSnapshot document : documents) {
                ...
                org.attendanceApp.application.entities.Student student = new org.attendanceApp.application.entities.Student(
                        id,
                        name);
